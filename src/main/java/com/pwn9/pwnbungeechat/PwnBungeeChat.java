package com.pwn9.pwnbungeechat;

import com.pwn9.pwnbungeechat.cmd.CommandHandler;
import com.pwn9.pwnbungeechat.cmd.commands.*;
import com.pwn9.pwnbungeechat.config.PwnBungeeChatConfig;
import com.pwn9.pwnbungeechat.listeners.ChatListener;
import com.pwn9.pwnbungeechat.listeners.PluginMessageListener;
 ...
 * @author Favorlock
 */
public class PwnBungeeChat extends Plugin {
	
	private final CommandHandler commandHandler = new CommandHandler(this);
	private ChannelManager channelManager;
	private ChatterManager chatterManager;
	private PwnBungeeChatConfig config;
	...
	public void onEnable() {
		try {
			// Initialize Config
			config = new PwnBungeeChatConfig(this);
			config.init();
		} catch(Exception ex) {
	...
	public PwnBungeeChatConfig getConfig() {
		return config;
	}
	...
	private void registerChannels() {
		getProxyServer().registerChannel("PwnBungeeChat");
	}
