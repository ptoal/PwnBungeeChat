...
public class RegexManager {
	...
	public RegexManager(PwnBungeeChat plugin) {
		this.plugin = plugin;
	...
	public void loadRules() {
		...
		if (!file.exists()) {
			...
			try {
				...
				output.write("# PwnBungeeChat rules.txt - Define Regular Expression Rules\n");
	...
	public void logToFile(String message) {
		...
		if (logEnabled) {
			try {
				File directory = new File("plugins" + File.separator + plugin.getDescription().getName());
				File file = new File(directory, "PwnBungeeChat.log");
